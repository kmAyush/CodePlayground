"""End-to-end manual check: English source -> Hindi source -> both outputs.

Reads inputs/good.py, translates it to Hindi, then runs the Hindi source
through the executor (Hindi output) and the original English source through
the sandbox (English output) so both can be compared side by side.
"""
